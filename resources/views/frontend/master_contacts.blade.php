                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="{{route('data_block-a')}}">Customers</a></li>
                              </ul>
                          </li>
  ...
  <div class="swiper-container" id="top">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url(assets/images/slide-09.jpg)">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <!-- Add more fields for other customer details as needed -->
