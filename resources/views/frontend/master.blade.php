...
<html lang="en">
  ...
  <head>
    ...
    <!-- <title>FairviewMexant - Financial HTML5 Template</title> -->
                  ...
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  <!-- <li><a href="about-us.html">About Us1</a></li> -->
                          
                                  <!-- <li><a href="our-services.html">Our Services</a></li> -->
                                  <!-- <li><a href="contact-us.html">Contact Us</a></li> -->
                                  <!-- <li><a href="{{route('data_block-a')}}">Data1</a></li> -->
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
                  <!-- <h2>This <em>would not</em> have achieved without the support of my beloved family<br>More <em>Apartments to come InshaAllah</em></h2> -->
        ...
        <div class="slide-inner" style="background-image:url(assets/images/slide-11.jpg)">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
                  <!-- <h2><em>First Visit  to start project - 13 July 2019,</em> Purpose was to register land and build property for rent <br> </h2> -->
                  <div class="div-dec"></div>
